...
void initialize_practical_04_scene(Viewer& viewer)
{
    ...
    //Define another spot light
    glm::vec3 s_position2(-10.0,5.0,-1.0), s_spotDirection2 = glm::normalize(glm::vec3(1.0,-1.0,1.0));
    //glm::vec3 s_ambient(0.0,0.0,0.0), s_diffuse(0.0,0.0,0.0), s_specular(0.0,0.0,0.0);
    glm::vec3 s_ambient2(0.1,0.2,0.3), s_diffuse2(0.9,0.9,0.6), s_specular2(0.7,0.8,0.9);
    float s_constant2=1.0, s_linear2=0.0, s_quadratic2=0.0;
    float s_cosInnerCutOff2 = std::cos(glm::radians(10.0f));
    float s_cosOuterCutOff2 = std::cos(glm::radians(60.0f));
