...
float Particle::getRadius() const
{
 ...
 float Particle::getAngleTheta() const 
{
    return 0.0;
}

 float Particle::getAnglePhi() const 
{
    return 0.0;
}

const glm::vec3 & Particle::getNormal() const
{
    glm::vec3 temporary = glm::vec3(0,0,1);
    return temporary;
}
...
void Particle::setAngleTheta(const float& angle){

}

 void Particle::setAnglePhi(const float& angle){
