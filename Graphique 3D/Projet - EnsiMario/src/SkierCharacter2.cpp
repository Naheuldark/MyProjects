...
std::shared_ptr<HierarchicalRenderable> buildASkier2 (ShaderProgramPtr phongShader, ShaderProgramPtr texShader) {
    ...
    std::shared_ptr<TexturedCubeRenderable> lefthair = std::make_shared<TexturedCubeRenderable>(texShader, "../textures/MarioSides.png");
    std::shared_ptr<TexturedCubeRenderable> righthair = std::make_shared<TexturedCubeRenderable>(texShader, "../textures/MarioSides.png");
    std::shared_ptr<TexturedCubeRenderable> backhair = std::make_shared<TexturedCubeRenderable>(texShader, "../textures/MarioSides.png");
    std::shared_ptr<TexturedCubeRenderable> cap = std::make_shared<TexturedCubeRenderable>(texShader, "../textures/pull.png");
    //std::shared_ptr<TexturedCubeRenderable> chin = std::make_shared<TexturedCubeRenderable>(texShader, "../textures/pull.png");
    ...
    //leftHair
    glm::mat4 lhairLocalTransform = glm::translate(glm::mat4(), glm::vec3(-0.5,0,0));
    lhairLocalTransform = glm::scale(lhairLocalTransform, glm::vec3(0.01, 1, 1));
    lefthair->setLocalTransform(lhairLocalTransform);
    lefthair->setMaterial(pearl);

    //rightHair
    glm::mat4 rhairLocalTransform = glm::translate(glm::mat4(), glm::vec3(0.5,0,0));
    rhairLocalTransform = glm::scale(rhairLocalTransform, glm::vec3(0.01, 1, 1));
    righthair->setLocalTransform(rhairLocalTransform);
    righthair->setMaterial(pearl);

    //backHair
    glm::mat4 bhairLocalTransform = glm::translate(glm::mat4(), glm::vec3(0,-0.5,0));
    bhairLocalTransform = glm::scale(bhairLocalTransform, glm::vec3(1, 0.01, 1));
    backhair->setLocalTransform(bhairLocalTransform);
    backhair->setMaterial(pearl);

    //cap
    glm::mat4 capLocalTransform = glm::translate(glm::mat4(), glm::vec3(0,0,0.5));
    capLocalTransform = glm::scale(capLocalTransform, glm::vec3(1, 1, 0.01));
    cap->setLocalTransform(capLocalTransform);
    cap->setMaterial(pearl);
    ...
    //upper right Arm
    auto upperRightArm = std::make_shared<KeyframedCylinderRenderable>(phongShader);
    upperRightArm->setParentTransform(GeometricTransformation( glm::vec3{0,-0.01,0.1}, glm::quat(), glm::vec3{1,1,1}).toMatrix() );
    upperRightArm->setLocalTransform(GeometricTransformation( glm::vec3{0.1,0.1,-1.1}, glm::quat(), glm::vec3{0.15,0.15,1}).toMatrix() );
    upperRightArm->addParentTransformKeyframe(0.0, GeometricTransformation( glm::vec3{0,-0.01,0.1}, glm::quat(glm::vec3(-0.4, -0.4, 0))) );
    upperRightArm->addParentTransformKeyframe(1.0, GeometricTransformation( glm::vec3{0,-0.01,0.1}, glm::quat(glm::vec3(0.2,0.2,0))) );
    upperRightArm->addParentTransformKeyframe(2.0, GeometricTransformation( glm::vec3{0,-0.01,0.1}, glm::quat(glm::vec3(-0.4,-0.4, 0))) );
    upperRightArm->setMaterial(ruby);
    ...
    //left upper left Arm
    auto upperLeftArm = std::make_shared<KeyframedCylinderRenderable>(phongShader);
    upperLeftArm->setParentTransform(GeometricTransformation( glm::vec3{-0.22,-0.24,0.1}, glm::quat(), glm::vec3{1,1,1}).toMatrix() );
    upperLeftArm->setLocalTransform(GeometricTransformation( glm::vec3{0.1,0.1,-1.1}, glm::quat(), glm::vec3{0.15,0.15,1}).toMatrix() );
    upperLeftArm->addParentTransformKeyframe(0.0, GeometricTransformation( glm::vec3{-0.22,-0.24,0.1}, glm::quat(glm::vec3(-0.4, -0.4, 0))) );
    upperLeftArm->addParentTransformKeyframe(1.0, GeometricTransformation( glm::vec3{-0.22,-0.24,0.1}, glm::quat(glm::vec3(0.2,0.2,0))) );
    upperLeftArm->addParentTransformKeyframe(2.0, GeometricTransformation( glm::vec3{-0.22,-0.24,0.1}, glm::quat(glm::vec3(-0.4,-0.4, 0))) );
    upperLeftArm->setMaterial(ruby);
