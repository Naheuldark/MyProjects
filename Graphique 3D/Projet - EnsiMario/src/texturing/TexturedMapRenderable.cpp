...
TexturedMapRenderable::TexturedMapRenderable(
...
{
    // Initialize geometry
    getUnitMap(30,200,80, m_positions, m_normals, m_origTexCoords);
...
void TexturedMapRenderable::do_draw()
{
    //Locations
...
void TexturedMapRenderable::do_animate(float time)
{
}


void TexturedMapRenderable::updateTextureOption()
{
...
void TexturedMapRenderable::do_keyPressedEvent( sf::Event& e )
{
...
void TexturedMapRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
