...
TexturedMountainsRenderable::TexturedMountainsRenderable(
...
{
    // Initialize geometry
    getMountainsSurrounding(30,200,80, m_positions, m_normals, m_origTexCoords);
...
void TexturedMountainsRenderable::do_draw()
{
    //Locations
...
void TexturedMountainsRenderable::do_animate(float time)
{
}


void TexturedMountainsRenderable::updateTextureOption()
{
...
void TexturedMountainsRenderable::do_keyPressedEvent( sf::Event& e )
{
...
void TexturedMountainsRenderable::setMaterial(const MaterialPtr& material)
{
    m_material = material;
}
