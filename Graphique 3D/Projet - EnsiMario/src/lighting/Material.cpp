...
MaterialPtr Material::Pearl()
{
    ...
    glm::vec3 ambient(0.85, 0.85, 0.85);
...
{
    float openGLFactor=128.0;
    glm::vec3 ambient(0.5, 0.01175, 0.01175);
    glm::vec3 diffuse(1.0, 0.04136, 0.04136);
    glm::vec3 specular(1, 0.626956, 0.626959);
    float shininess = openGLFactor*0.6;
    return std::make_shared<Material>(ambient, diffuse, specular, shininess);
}
...
MaterialPtr Material::Snow()
{
    ...
    glm::vec3 diffuse(0.9, 0.9, 1.0);
    glm::vec3 specular(0.8, 0.8, 0.8);
    float shininess = openGLFactor*0.25;
    return std::make_shared<Material>(ambient, diffuse, specular, shininess);
}

MaterialPtr Material::Wood()
{
    float openGLFactor=128.0;
    glm::vec3 ambient(0, 0, 0);
    glm::vec3 diffuse(0.25, 0.13, 0.01);
...
MaterialPtr Material::BlackPlastic()
{
    float openGLFactor=128.0;
    glm::vec3 ambient(0, 0, 0);
...
MaterialPtr Material::SkyBlue()
{
    float openGLFactor=128.0;
    glm::vec3 ambient(176.0/256, 224.0/256, 230.0/256);
