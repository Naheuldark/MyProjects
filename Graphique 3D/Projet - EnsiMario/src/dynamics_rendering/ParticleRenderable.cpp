...
void ParticleRenderable::do_draw()
{
    ...
    const float& pAngleTheta = m_particle->getAngleTheta();
    const float& pAnglePhi = m_particle->getAnglePhi();
    glm::mat4 scale = glm::scale(glm::mat4(1.0), glm::vec3(pRadius));
    glm::mat4 translate = glm::translate(glm::mat4(1.0), glm::vec3(pPosition));
    glm::mat4 rotationTheta = glm::rotate(glm::mat4(), (glm::mediump_float)pAngleTheta,glm::vec3(0.0, 0.0, 1.0));
    glm::mat4 rotationPhi = glm::rotate(glm::mat4(), (glm::mediump_float)pAnglePhi,glm::vec3(1.0, 1.0, 0.0));
    glm::mat4 rotationTotale = glm::rotate(rotationTheta,(glm::mediump_float)pAnglePhi,glm::vec3(0.0, 1.0, 0.0));
    //setParentTransform(scale*translate*rotation);
    setParentTransform(translate*scale*rotationTotale);
