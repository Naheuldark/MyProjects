...
public:
    ...
    virtual float getAngleTheta() const;

    virtual float getAnglePhi() const;

    virtual const glm::vec3& getNormal() const;
    ...
    virtual void setAngleTheta(const float& angle);

    virtual void setAnglePhi(const float& angle);

    virtual void setNormal(const glm::vec3& normal);
