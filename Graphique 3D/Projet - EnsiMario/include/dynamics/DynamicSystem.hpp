...
private:
    ...
    /**@brief The set of particleSkier managed by this system.
     *
     * The particleSkier managed by this dynamic system. Their positions
     * and velocities will be updated thanks to the solver, taking into
     * account the force field applied to them.
     */
    std::vector<ParticleSkierPtr> m_particlesSkier;
...
public:
    ...
    /**@brief Add a particleSkier to the system.
     *
     * Add a particle to this dynamic system.
     * @param p The particle to add to this system.
     */
    void addParticleSkier(ParticleSkierPtr pS);
    ...
    /**@brief Access to the set of particlesSkier of this system.
     *
     * Get the set of particles of this dynamic system.
     * @return The set of particles of this system.
     */
    const std::vector<ParticleSkierPtr>& getParticlesSkier() const;
    ...
    /**@brief Set the particlesSkier of this system.
     *
     * Define a new set of particles for this dynamic system.
     * @param particles The new set of particles of this system.
     */
    void setParticlesSkier(const std::vector<ParticleSkierPtr> & particlesSkier);
