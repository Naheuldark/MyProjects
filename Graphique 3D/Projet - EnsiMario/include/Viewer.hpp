...
public:
    ...
    /**\brief Update the chrono for the viewer
    */
    float getChrono();
    ...
    */
     ...
     * \brief rmRenderable
     *
     * Remove a renderable from the set of renderabbles \ref m_renderables of the viewer.
     * \param r A renderable to remove to \ref m_renderables.
     */
    void rmRenderable( RenderablePtr r );
...
private:
    ...
    bool m_gameover = false; /*!< Is the Game finished ? */
    bool m_pause = false; /*!< Is the Game paused ? */
    float m_chronoTime; /*!< Current chrono time in the animation loop. */
    TimePoint m_lastChronoTimePoint; /*!< Date of the last chrono. */
