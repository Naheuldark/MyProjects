#include "pgm.h"
/* 
    Calcul de l'inverse video d'une image. 
    Si le parametre sortie est NULL, on cree une nouvelle image.
    On parcourt toute l'image ligen par ligne, colonne par colonne, 
    on calcule son inverse video et on retourne l'image ainsi modifiee
*/

unsigned char** inverse(unsigned char** sortie,  
