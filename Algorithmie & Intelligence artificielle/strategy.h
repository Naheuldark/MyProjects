...
public:
    ...
    vector<move>& computeValidMoves (vector<move>& valid_moves) const;
         ...
         */
    Sint32 estimateCurrentScore (int player) const;

        /**
         * Implements the Greedy strategy
         */
    move& findMoveGreedy(move& mv);

        /**
         * Implements the Min-Max strategy
         */
    move& findMoveMinMax(move& mv, int profondeur);
    Sint32 findMoveMinMaxRec(int currentDepth, int maxDepth, int player);
